...
class MoNaPiEngine:
    ...
    def _preprocess_image(self, image: np.ndarray) -> torch.Tensor:
        ...
        """
        # 학습(data/preprocessing.py·dataset.py)과 동일한 BILINEAR 보간 — 미지정 시
        # Pillow 기본값(BICUBIC)으로 떨어져 train/inference 리사이즈 불일치 발생
        # (MoNaVLA에서 같은 클래스 버그 확인, docs/MONAVLA_CROSSCHECK_20260623.md).
